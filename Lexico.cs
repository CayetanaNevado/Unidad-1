...
namespace Evalua
{
    public class Lexico : Token
    {
        ...
        {
            linea = 1;
            string path = "C:\\Users\\ACER\\Desktop\\5 Semestre\\Lenguajes Automatas 2\\Evalua\\prueba.cpp";
            bool existencia = File.Exists(path);
            log = new StreamWriter("C:\\Users\\ACER\\Desktop\\5 Semestre\\Lenguajes Automatas 2\\Evalua\\prueba.Log"); 
            log.AutoFlush = true;
